output "network_security_group_id" {
  ...
  value       = azurerm_network_security_group.nsg_example.id
}
...
output "resource_group_name" {
  ...
  value       = azurerm_network_security_group.nsg_example.resource_group_name
}

output "nsg_location" {
  description = "The location of the network security group."
  value       = azurerm_network_security_group.nsg_example.location
}